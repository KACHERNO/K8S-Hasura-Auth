...
- Проект предназначен для тестирования GraphQL-API (аутентификация, авторизация, вопросы настройки "ролевого" разграничения доступа, изучение GraphQL и т.д. и т.п.).
